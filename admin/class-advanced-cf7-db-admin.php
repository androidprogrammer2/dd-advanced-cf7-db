...
class Advanced_Cf7_Db_Admin {
	...
	*/
	...
	function vsz_cf7_plugin_menu(){
		...
		add_menu_page( "DD Advanced CF7 DB", "DD Advanced CF7 DB", $cap, "contact-form-listing", array($this,"vsz_contact_form_callback"), 'dashicons-visibility' , 45);
		...
		add_submenu_page( 'contact-form-listing', __('All Forms', 'advanced-cf7-db'), __('All Forms', ' advanced-cf7-db'), 'administrator', 'all-form-listing',function () {

			include(dirname(__FILE__).'/../includes/db7-list.php');
		});
	}
	...
	*/
	...
	public function vsz_cf7_add_new_table_for_sites($blog_id){
		...
		global $wpdb;
		if (is_plugin_active_for_network('advanced-cf7-db/dd-advanced-cf7-db.php')) {
